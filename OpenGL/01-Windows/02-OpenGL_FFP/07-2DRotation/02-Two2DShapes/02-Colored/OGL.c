...
void Render()
{
	...
	glRotatef(angleOfTriangle, 0.0f, 1.0f, 0.0f);
	...
	glTranslatef(1.5f, 0.0f, -6.0f);
	glRotatef(angleOfTriangle, 1.0f, 0.0f, 0.0f);
	// Draw Rectangle
	glBegin(GL_QUADS);
...
void Update()
{
	...
	angleOfTriangle += 0.1f;
	if(angleOfTriangle > 360.0f)
	{
		angleOfTriangle = 0.0f;
	}
}
