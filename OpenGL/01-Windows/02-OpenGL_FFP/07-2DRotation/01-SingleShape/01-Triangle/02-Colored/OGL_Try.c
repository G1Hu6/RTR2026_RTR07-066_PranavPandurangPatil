...
float angleOfTriangleX = 0.0f;
float angleOfTriangleY = 0.0f;
float angleOfTriangleZ = 0.0f;
...
void Render()
{
	...
	// Rotation
	glRotatef(
		angleOfTriangleX, // angle of rotation
		1.0f, // x
		0.0f, // y
		0.0f  // z	
	);
	...
	glTranslatef(2.5f, 0.0f, 0.0f);
        ...
        // Rotation
        glRotatef(
                angleOfTriangleY, // angle of rotation
                0.0f, // x
                1.0f, // y
                0.0f  // z
        );
	...
	glTranslatef(-2.5f, 0.0f, 0.0f);
        ...
        // Rotation
        glRotatef(
                angleOfTriangleZ, // angle of rotation
                0.0f, // x
                0.0f, // y
                1.0f  // z
        );
...
void Update()
{
	...
	angleOfTriangleX += 0.10f;
	angleOfTriangleY += 0.10f;
	angleOfTriangleZ += 0.10f;

	if(angleOfTriangleX > 360.0f)
	{
		angleOfTriangleX = 0.0f;
	}

	if(angleOfTriangleY > 360.0f)
	{
		angleOfTriangleY = 0.0f;
	}
	
	if(angleOfTriangleZ > 360.0f)
	{
		angleOfTriangleZ = 0.0f;
	}
}
