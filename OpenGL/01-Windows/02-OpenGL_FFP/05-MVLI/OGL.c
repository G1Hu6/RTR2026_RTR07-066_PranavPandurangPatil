...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) // declarator
{
	...
	glutCreateWindow("My First RTR-7 Program : Pranav P Patil");
	...
	*/
	...
	hwnd = CreateWindowEx( // step 1: use extended style
		...
		szAppName, 
		TEXT("My First RTR07 Window Program : Harshal Wadne"), // glutCreateWindow("...")
...
void Render()
{
	...
	glTranslatef(2.5f, 0.0f, 0.0f); // move to right side x positive
	// Draw Colored Triangle
	ColoredTriangle();

	glTranslatef(0.0f, 2.0f, 0.0f); // move to top side y positive
